...
@push('styles')
    ...
    <style>
        /* ==========================================================================
           MEMBUANG NAVBAR DAN SIDEBAR ADMIN KHUSUS UNTUK HALAMAN INI
           ========================================================================== */
        .navbar, 
        .main-navbar, 
        .main-sidebar, 
        ...
        /* Menggeser konten ke kiri penuh karena ruang sidebar sudah dibuang */
        .main-content { 
        ...
        /* Hilangkan margin/padding bagian bawah footer jika ikut tergeser */
        .main-footer {
            display: none !important;
        }
        /* ========================================================================== */
